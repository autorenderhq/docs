...
```bash
https://assets.autorender.io/LOKVTtKVGb/w_500/doc1/porsche.jpg
```

<img src="https://assets.autorender.io/LOKVTtKVGb/w_720/doc1/porsche.jpg" alt="Width 720px (rounded from 500)" style={{ borderRadius: '0.5rem', maxWidth: '100%' }} />

Request: `w_1500` → Automatically rounded to `w_1920`:

```bash
https://assets.autorender.io/LOKVTtKVGb/w_1500/doc1/porsche.jpg
```

<img src="https://assets.autorender.io/LOKVTtKVGb/w_1920/doc1/porsche.jpg" alt="Width 1920px (rounded from 1500)" style={{ borderRadius: '0.5rem', maxWidth: '100%' }} />

Request: `w_1080` → Stays at `w_1080` (already a bucket size):

```bash
https://assets.autorender.io/LOKVTtKVGb/w_1080/doc1/porsche.jpg
```

<img src="https://assets.autorender.io/LOKVTtKVGb/w_1080/doc1/porsche.jpg" alt="Width 1080px (bucket size)" style={{ borderRadius: '0.5rem', maxWidth: '100%' }} />
...
<img src="https://assets.autorender.io/LOKVTtKVGb/w_1080/doc1/porsche.jpg" alt="Auto width 1080px for iPhone/Desktop" style={{ borderRadius: '0.5rem', maxWidth: '100%' }} />
...
<img src="https://assets.autorender.io/LOKVTtKVGb/w_480/doc1/porsche.jpg" alt="Auto width 480px for Save-Data mode" style={{ borderRadius: '0.5rem', maxWidth: '100%' }} />
...
```bash
https://assets.autorender.io/LOKVTtKVGb/q_80,w_720,c_crop/doc1/porsche.jpg
```

<img src="https://assets.autorender.io/LOKVTtKVGb/c_crop,w_720,q_80/doc1/porsche.jpg" alt="Auto-ordered transformation" style={{ borderRadius: '0.5rem', maxWidth: '100%' }} />

Parameter order: crop, quality, width (reordered automatically):

```bash
https://assets.autorender.io/LOKVTtKVGb/c_crop,q_80,w_720/doc1/porsche.jpg
```
...
```bash
https://assets.autorender.io/LOKVTtKVGb/t_thumbnail-2/doc1/porsche.jpg
```

<img src="https://assets.autorender.io/LOKVTtKVGb/c_fill,w_200,h_200,p_c/doc1/porsche.jpg" alt="Preset token thumbnail" style={{ borderRadius: '0.5rem', maxWidth: '100%' }} />
...
```bash
https://assets.autorender.io/LOKVTtKVGb/c_fill,w_200,h_200,p_c/doc1/porsche.jpg
```
...
<img src="https://assets.autorender.io/LOKVTtKVGb/w_1080/doc1/porsche.jpg" alt="Responsive image with automatic width" style={{ borderRadius: '0.5rem', maxWidth: '100%' }} />
...
```bash
https://assets.autorender.io/LOKVTtKVGb/w_650/doc1/porsche.jpg
```

<img src="https://assets.autorender.io/LOKVTtKVGb/w_720/doc1/porsche.jpg" alt="Width bucketing example" style={{ borderRadius: '0.5rem', maxWidth: '100%' }} />
...
```bash
https://assets.autorender.io/LOKVTtKVGb/q_80,c_fill,w_800,h_600/doc1/porsche.jpg
```

<img src="https://assets.autorender.io/LOKVTtKVGb/c_fill,w_800,h_600,q_80/doc1/porsche.jpg" alt="Auto-ordered transformations" style={{ borderRadius: '0.5rem', maxWidth: '100%' }} />
...
<img src="https://assets.autorender.io/LOKVTtKVGb/c_fill,w_200,h_200,p_c/doc1/porsche.jpg" alt="Preset token example" style={{ borderRadius: '0.5rem', maxWidth: '100%' }} />

Preset with additional parameters:

```bash
https://assets.autorender.io/LOKVTtKVGb/t_thumbnail-2,q_90/doc1/porsche.jpg
```

<img src="https://assets.autorender.io/LOKVTtKVGb/c_fill,w_200,h_200,p_c,q_90/doc1/porsche.jpg" alt="Preset with additional parameters" style={{ borderRadius: '0.5rem', maxWidth: '100%' }} />
