...
<img src="https://assets.autorender.io/LOKVTtKVGb/thumb_ar/doc/skateboarding.mp4" alt="Thumbnail preview" style={{ maxWidth: '100%', display: 'block', marginLeft: 'auto', marginRight: 'auto', objectFit: 'contain' }} />
