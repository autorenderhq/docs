...
A **Web Server** source lets you point Autorender at any HTTP origin — your own server, a CDN, or a third-party host — and start delivering optimized images without moving a single file.
...
3. Set **Origin Type** to **Image Source**.
